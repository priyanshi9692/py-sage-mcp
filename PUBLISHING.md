...
```json
{
  ...
  "version": "0.1.0",
  "author": "Adobe Engineers",
  "license": "MIT",
  "repository": "https://github.com/adobe/python-code-guardian-mcp",
  "homepage": "https://github.com/adobe/python-code-guardian-mcp",
  "categories": [
    "code-quality",
    "linting",
    "testing",
...
## Repository
https://github.com/adobe/python-code-guardian-mcp
...
- Write blog post on Adobe Tech Blog
